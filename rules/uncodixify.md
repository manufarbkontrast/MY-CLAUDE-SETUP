...
- Colors going towards blue — dark muted colors are best
...
- Sidebar width around 280px with a brand block on top
...
- Decorative copy as page headers
- Section notes explaining what the UI does
- Transform animations on hover
- Dramatic box shadows (e.g. 0 24px 60px)
...
1. **Highest priority:** Use existing colors from the user's project (search for them)
2. If no project palette, get inspired from predefined palettes below
